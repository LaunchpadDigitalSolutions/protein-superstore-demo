...
const CONFIG = {
  ...
  shell: [
    ...
    './index.html',
    './css/psp.css?v=1.2.1',
    './css/staff.css?v=1.2.1',
    './css/psp-screens.css?v=1.2.1',
    './core/tokens.css?v=1.2.1',
    './core/ui.css?v=1.2.1',
    './icon-192.png',
    './icon-512.png',
    './assets/logo.jpg?v=1.2.1',
    './assets/hero.jpg?v=1.2.1',
    './assets/slush-hero.jpg?v=1.2.1',
    './assets/slush-pair.jpg?v=1.2.1'
  ],
